        ...
        <div className="w-full fixed top-0 left-0">
            <div className="md:flex items-center justify-between bg-white py-4 md:px-10 px-7">
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] w-full left-0 md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20' : 'top-[-490px]'}`}>
                    <li className='mr-6 md:my-0 my-7 text-gray-700 hover:text-indigo-600'><Link to="/contacts">Контакти</Link></li>
                    <li className='mr-6 md:my-0 my-7 text-gray-700 hover:text-indigo-600'><Link to="/pricing">Услуги</Link></li>
                    <li className='mr-6 md:my-0 my-7 text-gray-700 hover:text-indigo-600'><Link to="/apply">Работи от вкъщи</Link></li>
                </ul>
            </div>
        </div>
    )
