...
export default function Footer() {
  return (
    <section className="bg-gray-800 insert-x-0 bottom-0 flex items-center justify-center w-full mt-16">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex justify-center mt-8 space-x-6">
          ...
          <a href="https://www.instagram.com/itserviceskn/" target="_blank" rel="noreferrer" className="text-white">
          ...
          <a href="https://www.youtube.com/channel/UCdB_feG3NWKZasmgn4KOChQ?view_as=subscriber" target="_blank" rel="noreferrer" className="text-white">
